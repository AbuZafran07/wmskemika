...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "menu.trackerPOSub": "Purchase Order Kanban",
    "menu.trackerKalibrasi": "Tracker Kalibrasi",
    "menu.trackerKalibrasiSub": "Calibration Kanban",
  ...
  id: {
    ...
    "menu.trackerPO": "Tracker PO",
    "menu.trackerPOSub": "Kanban Purchase Order",
    "menu.trackerKalibrasi": "Tracker Kalibrasi",
    "menu.trackerKalibrasiSub": "Kanban Kalibrasi",
    "menu.planOrder": "Plan Order",
